...
UPDATE `mangos_string` SET `content_loc8` = 'Поступила новая заявка от %s' WHERE `entry` = 289;
UPDATE `mangos_string` SET `content_loc8` = 'Заявка от %s (Последний раз редактировалась: %s):\n%s' WHERE `entry` = 290;
UPDATE `mangos_string` SET `content_loc8` = 'Показывать новые заявки: Включено' WHERE `entry` = 291;
UPDATE `mangos_string` SET `content_loc8` = 'Показывать новые заявки: Отключено' WHERE `entry` = 292;
UPDATE `mangos_string` SET `content_loc8` = 'Заявки %i не существует' WHERE `entry` = 293;
UPDATE `mangos_string` SET `content_loc8` = 'Все заявки удалены.' WHERE `entry` = 294;
UPDATE `mangos_string` SET `content_loc8` = 'Заявка персонажа %s удалена.' WHERE `entry` = 295;
UPDATE `mangos_string` SET `content_loc8` = 'Заявка удалена.' WHERE `entry` = 296;
