...
-- Tydormu
(@CEGUID+1, 23381, 534, 1, 0, 0, 4209.16, -4167.73, 870.597, 1.72777, 120, 120, 0, 0, 5715, 0, 0, 2),
-- Indormi
(@CEGUID+2, 23437, 534, 1, 0, 0, 4207.03, -4174.95, 870.202, 1.01229, 120, 120, 0, 0, 6986, 0, 0, 0);
...
(2000003293, 'Do you think the rumors about the Infinite Dragonflight are true?  I''ve sensed it... the familiarity.', 0, 0, 0, 1, 21646, 'Indormi (Entry: 23437)'),
(2000003294, 'That is a dangerous train of thought.  If something was truly amiss, Soridormi would be the first to know.', 0, 0, 0, 274, 21645, 'Tydormu (Entry: 23381)'),
(2000003295, '%s begins channelling a massive teleport spell.', 0, 7, 0, 0, 15310, 'Lady Jaina Proudmoore (Entry: 17772)');
...
(@CNGUID+57, 22418, 534, 1, 18783, 0, 5502.288, -3525.471, 1607.909, 2.617994, 604800, 604800, 0, 0, 7588, 0, 0, 0); -- Note that this trigger is not here in a fresh instance. It is most likely spawned together with Archimonde.
