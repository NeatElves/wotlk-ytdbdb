...
(1726401, 0, 0, 0, 0, 0, 17269, @CGUID+29, 17, 2000003812, 0, 0, 0, 0, 0, 0, 0, 'Bonechewer Ravener (Hellfire Ramparts) - Yell At Bleeding Hollow Darkcaster'),
(1726401, 4000, 0, 0, 0, 0, 17269, @CGUID+29, 19, 2000003813, 0, 0, 0, 0, 0, 0, 0, 'Bleeding Hollow Darkcaster (Hellfire Ramparts) - Yell At Bonechewer Ravener');

DELETE FROM `dbscript_string` WHERE `entry` IN (2000003812,2000003813);
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `broadcast_text_id`, `comment`) VALUES
(2000003812, 'You there!  Keep a close watch on these ramparts, intruders could approach at any time!', 0, 1, 0, 25, 13695, 'Bonechewer Ravener in Hellfire Ramparts'),
(2000003813, 'Yes sir!  I will not fail the Fel Horde!', 0, 1, 0, 66, 13989, 'Bleeding Hollow Darkcaster in Hellfire Ramparts');
