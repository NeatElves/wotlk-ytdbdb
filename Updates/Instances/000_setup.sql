...
-- supported maps (34,48,209,249,269,389,534,544,553,554,555,565,578,601)
...
CREATE TABLE tmp_creature (SELECT guid, id, map FROM creature WHERE map IN (34,48,209,249,269,389,534,544,553,554,555,565,578,601));
CREATE TABLE tmp_gameobject (SELECT guid, id, map FROM gameobject WHERE map IN (34,48,209,249,269,389,534,544,553,554,555,565,578,601));
