...
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` IN (888,7207,20666,21025,22865,22990,30366,32838,33211,33224);
...
UPDATE creature_template SET SpellList = 454301 WHERE entry = 4543;
UPDATE creature_template SET SpellList = 1468201 WHERE entry = 14682;
UPDATE creature_template SET SpellList = 1468601 WHERE entry = 14686;
UPDATE creature_template SET SpellList = 1614101 WHERE entry = 16141;
UPDATE creature_template SET SpellList = 1629901 WHERE entry = 16299;
UPDATE creature_template SET SpellList = 1629801 WHERE entry = 16298;
UPDATE creature_template SET SpellList = 1469701 WHERE entry = 14697;
UPDATE creature_template SET SpellList = 1638001 WHERE entry = 16380;
UPDATE creature_template SET SpellList = 1637901 WHERE entry = 16379;
UPDATE creature_template SET SpellList = 1643801 WHERE entry = 16438;
DELETE FROM `creature_spell_list` WHERE `Id` IN (454301,1468201,1468601,1614101,1629901,1629801,1469701,1638001,1637901,1643801);
...
(454301, 0, 8814, 0, 100, 0, 100, 0, 0, 8, 8, 16, 'Scarlet Monastery - Bloodmage Thalnos - Flame Spike'),
(454301, 1, 12470, 0, 0, 0, 100, 0, 0, 9, 9, 12, 'Scarlet Monastery - Bloodmage Thalnos - Fire Nova'),
(454301, 2, 8053, 0, 1, 0, 100, 0, 0, 16, 16, 60, 'Scarlet Monastery - Bloodmage Thalnos - Flame Shock (Rank 3)'),
(454301, 3, 9613, 2, 1, 0, 100, 0, 0, 3, 3, 5, 'Scarlet Monastery - Bloodmage Thalnos - Shadow Bolt'),
(1468201, 0, 16508, 0, 1, 0, 100, 0, 5, 20, 30, 60, 'Shadowfang Keep - Sever - Intimidating Roar'),
(1468201, 1, 17745, 0, 1, 0, 100, 0, 5, 8, 8, 16, 'Shadowfang Keep - Sever - Diseased Spit'),
(1468601, 0, 16838, 0, 1, 0, 100, 0, 0, 20, 20, 20, 'Razorfen Downs - Lady Falther''ess - Banshee Shriek'),
(1468601, 1, 17105, 0, 1, 0, 100, 0, 0, 30, 12, 30, 'Razorfen Downs - Lady Falther''ess - Banshee Curse'),
(1468601, 2, 22743, 0, 1, 0, 100, 0, 0, 25, 5, 25, 'Razorfen Downs - Lady Falther''ess - Ribbon of Souls'),
(1468601, 3, 7645, 0, 100, 0, 100, 0, 10, 30, 30, 60, 'Razorfen Downs - Lady Falther''ess - Dominate Mind'),
(1614101, 0, 7367, 0, 1, 0, 100, 50, 6, 12, 6, 12, 'Scourge Invasion - Ghoul Berserker - Infected Bite'),
(1629901, 0, 17014, 0, 0, 0, 100, 0, 0, 16, 16, 16, 'Scourge Invasion - Skeletal Shocktrooper - Bone Shards'),
(1629801, 0, 16244, 0, 0, 0, 100, 50, 0, 20, 20, 20, 'Scourge Invasion - Spectral Soldier - Demoralizing Shout'),
(1629801, 1, 21081, 0, 1, 0, 100, 50, 6, 12, 6, 12, 'Scourge Invasion - Spectral Soldier - Sunder Armor'),
(1469701, 0, 16790, 0, 1, 0, 100, 0, 0, 17, 17, 17, 'Scourge Invasion - Lumbering Horror - Knockdown'),
(1469701, 1, 5568, 0, 0, 0, 100, 0, 5, 10, 5, 10, 'Scourge Invasion - Lumbering Horror - Trample'),
(1638001, 0, 17014, 0, 0, 0, 100, 50, 1, 8, 8, 19, 'Scourge Invasion - Bone Witch - Bone Shards'),
(1638001, 1, 20720, 2, 1, 0, 100, 0, 1, 3, 3, 3, 'Scourge Invasion - Bone Witch - Arcane Bolt'),
(1637901, 0, 22884, 0, 0, 0, 100, 0, 1, 12, 6, 12, 'Scourge Invasion - Spirit of the Damned - Psychic Scream'),
(1637901, 1, 16243, 2, 1, 0, 100, 0, 1, 6, 3, 6, 'Scourge Invasion - Spirit of the Damned - Ribbon of Souls'),
(1643801, 0, 589, 0, 1, 0, 100, 0, 1, 9, 9, 18, 'Scourge Invasion - Skeletal Trooper - Shadow Word: Pain (Rank 1)');
